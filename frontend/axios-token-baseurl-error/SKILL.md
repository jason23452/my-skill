...
```opencode-bootstrap-json
{
  ...
  "packageManager": "pnpm",
  "scaffoldCommand": [
    "if test -f .opencode/skills/axios-token-baseurl-error/scripts/bootstrap-02-01.cjs; then node .opencode/skills/axios-token-baseurl-error/scripts/bootstrap-02-01.cjs; else node ${OPENCODE_PROJECT_SKILLS_PRESEEDED_DIR:-/app/.opencode/skills}/axios-token-baseurl-error/scripts/bootstrap-02-01.cjs; fi"
  ],
  "verificationCommands": []
}
```

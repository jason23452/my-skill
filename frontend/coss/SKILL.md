...
`COSS_COMPONENTS` 會讓 bootstrap batch install 指定 components 加上 neutral colors；`COSS_BOOTSTRAP_MODE=full-style` 才會改用 `@coss/style`。

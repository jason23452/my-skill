...
- `requirements-clarity`：診斷 actor、problem、slice、entry point、visible outcome、boundary、failure / edge、acceptance 缺口。
...
- 每條 story 必須能通過 `requirements-clarity` gap check：有角色、情境或入口、單一核心動作、可見成功結果、邊界或例外、可驗收 AC。

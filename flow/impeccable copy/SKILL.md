---
name: impeccable-copy
description: Archived reference copy of the Impeccable frontend design skill. Use only when explicitly maintaining this archived copy; active UI design work should use the main impeccable skill.
metadata:
  version: "3.9.1"
  archived: "true"
---
